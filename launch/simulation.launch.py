...
This file starts Gazebo simulator with the chosen Neobotix robot base, robot arm and simulation environment. 

The following command launches the simulation with sample arguments.
    `ros2 launch neo_simulation2 simulation.launch.py my_robot:=mp_500 map_name:=neo_track1 use_sim_time:=true use_robot_state_pub:=true`

To list the arguments that can be passed, use the following command.
